...
maphosp <- st_read("C:/Users/pvelazquez/Google Drive/MEXICO MAPA/Baja California/conjunto de datos/02sip.shp")
...
ggmap(tjmap) + 
  ...
  scale_size_discrete(range = c(3,21), breaks = pretty_breaks(n = 4)) + 
  scale_y_continuous(limits = c(32.397, 32.56)) +
